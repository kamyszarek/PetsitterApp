IF NOT EXISTS(SELECT * FROM sys.databases WHERE name = 'petsitter')
  BEGIN
...
drop table confirm_new_account;
...
int			int				NOT NULL constraint pk5_id primary key identity(1,1),
...
id				int				NOT NULL constraint pk6_id primary key identity(1,1),
